...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/voca/learn">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/voca/learn">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="/voca/admin/category-list">
                    <i class="fas fa-fw fa-table"></i>
                    <span>카테고리 관리</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/voca/admin/voca-list">
                    <i class="fas fa-fw fa-table"></i>
                    <span>단어 관리</span></a>
            </li>
